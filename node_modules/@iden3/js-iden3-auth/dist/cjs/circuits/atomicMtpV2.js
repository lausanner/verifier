...
exports.AtomicQueryMTPV2PubSignals = void 0;
...
class AtomicQueryMTPV2PubSignals extends ownershipVerifier_1.IDOwnershipPubSignals {
    constructor(pubSignals) {
        ...
        this.issuerClaimIdenState = (0, js_merkletree_1.newHashFromString)(pubSignals[fieldIdx]);
        fieldIdx++;
        // - isRevocationChecked
    ...
    async verifyStates(resolvers, opts) {
        ...
        await (0, common_1.checkUserState)(resolver, this.issuerID, this.issuerClaimIdenState);
