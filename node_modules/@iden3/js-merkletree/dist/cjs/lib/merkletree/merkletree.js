...
class Merkletree {
    ...
    async add(k, v) {
        ...
        await __classPrivateFieldGet(this, _Merkletree_db, "f").setRoot(this.root);
    }
    async updateNode(n) {
        if (!__classPrivateFieldGet(this, _Merkletree_writable, "f")) {
            throw errors_1.ErrNotWritable;
