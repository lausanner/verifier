...
export class Merklizer {
    constructor(srcDoc = null, mt = null, hasher = DEFAULT_HASHER, entries = new Map(), compacted = null) {
        this.srcDoc = srcDoc;
        this.mt = mt;
        this.hasher = hasher;
    ...
    static async merklizeJSONLD(docStr, opts) {
        ...
        mz.compacted = await compact(doc, {}, { documentLoader: jsonLdDocLoader, base: null, compactArrays: true, compactToRelative: true });
        return mz;
    }
